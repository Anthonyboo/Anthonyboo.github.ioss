...
(function ($) {
	var defaults = {
		...
		agreementLink: '/usloviya-raboty-sajta',
		...
		//** Заголовок формы
		callFormTitle: 'Оставьте ваш номер телефона, и наш специалист свяжется с вами',

		//** Текст кнопки отправляющей форму
		buttonTextCallForm: 'Отправить',

		//** Картинка в модальном окне
		callFormIcon: '/smartlid/img/icon-phone.png',
		...
		//** Заголовок формы
		requestFormTitle: 'Оставьте сообщение, и наш специалист свяжется с вами',
